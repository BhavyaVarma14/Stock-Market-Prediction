def gb(data,cv,taf):
    ...
    fig.update_layout(title='Actual vs Predicted (GB)', xaxis_title='Date', yaxis_title='Price',width=1000, height=400)
    st.plotly_chart(fig)
    fig = go.Figure()
    ...
    fig.update_layout(title='Actual vs Predicted(Validation) (GB)', xaxis_title='Date', yaxis_title='Price',width=1000, height=400)
    st.plotly_chart(fig)